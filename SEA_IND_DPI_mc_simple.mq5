...
//+------------------------------------------------------------------+
//| DPI_mc_simple.mq5                                                 |
//| Renamed from: DPI_v29_OK_CLEAN.mq5  (logic unchanged)            |
//|                                                                   |
//| Naming convention:                                                |
...
int OnInit()
{
   ...
   // Set index buffers (5 visible plots + 3 internal)
   ...
   SetIndexBuffer(7, g_CCI,         INDICATOR_CALCULATIONS);
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, 
                      ...
                      IntegerToString(InpSlowEMA) + ", " + red_label + ")" + cci_label);
