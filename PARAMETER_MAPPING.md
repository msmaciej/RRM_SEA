...
| `Inp_EndHour` | `Inp_Filter_EndHour` | Filters | Yes |
| `Inp_HtfEmaPeriod` | `Inp_Filter_HtfEmaPeriod` | Filters | Yes |
| `Inp_HtfPeriod` | `Inp_Filter_HtfPeriod` | Filters | Yes |
| `Inp_MaxSpreadPips` | `Inp_Filter_MaxSpreadPips` | Filters | Yes |
| `Inp_MaxSpreadRetryBars` | `Inp_Filter_MaxSpreadRetryBars` | Filters | Yes |
| `Inp_NewsFile` | `Inp_Filter_NewsFile` | Filters | Yes |
| `Inp_NewsPost` | `Inp_Filter_NewsPost` | Filters | Yes |
| `Inp_NewsPre` | `Inp_Filter_NewsPre` | Filters | Yes |
| `Inp_StartHour` | `Inp_Filter_StartHour` | Filters | Yes |
| `Inp_UseHTF` | `Inp_Filter_UseHTF` | Filters | Yes |
| `Inp_UseNews` | `Inp_Filter_UseNews` | Filters | Yes |
| `Inp_UseSpread` | `Inp_Filter_UseSpread` | Filters | Yes |
| `Inp_UseTime` | `Inp_Filter_UseTime` | Filters | Yes |
