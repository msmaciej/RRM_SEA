# PRESET_RRM_ORG v04 — Russ Horn RRM (Original, quality-gated)

**Status: IMPLEMENTED & DEFAULT.** Same engine as v01 (`SEA_Presets.mqh`, `if(preset == PRESET_RRM_ORG)`;
shared `EvaluateTS_Breakdown` core in `SEA_SignalEngine.mqh`). v04 is the input set and the four code
...
`_SEA-RRM-ORG/_FX-RRM-ORG-Trading_System_v04.png`.
