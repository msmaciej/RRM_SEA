...
All thresholds below are for M5 timeframe. Higher TFs use proportionally larger base values (M30=80, H1=120, H4=200, D1+=350 for TopInvestor; M5=25 for RRM/RRM_ORG).

| Instrument class | Detection | Multiplier | PRESET_RRM (base 25p) | PRESET_TOPINVESTOR (base 50p) |
|---|---|---|---|---|
| Forex majors/crosses | Default | 1.0x | 25 pips | 50 pips |
| Forex JPY pairs | Symbol contains "JPY" | 1.5x | 37.5 pips | 75 pips |
| Oil (WTI, Brent) | "WTI", "BRENT", "OIL", "USOIL", "UKOIL" | 8.0x | 200 pips | 400 pips |
| Silver (XAG) | "XAG", "SILVER" | 10.0x | 250 pips | 500 pips |
| Indices | "NAS", "US30", "US500", "SPX", "DAX", "GER", "UK100", "FTSE", "JP225", "NIKKEI", "FRA40", "AUS200", "STOXX", "HSI" | 15.0x | 375 pips | 750 pips |
| Gold (XAU) | "XAU", "GOLD" | 20.0x | 500 pips | 1000 pips |
| Crypto (BTC, ETH) | "BTC", "ETH", "CRYPTO" | 25.0x | 625 pips | 1250 pips |
