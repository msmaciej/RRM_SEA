...
input string Inp_META_OutDir      = "";         // Inp_META_OutDir: absolute folder for CSVs (empty = MT5 Files). Use FULL Wine path.

//==================== FILE NAMES (derived from preset) =============
string MetaDir()        { return (StringLen(Inp_META_OutDir)>0) ? Inp_META_OutDir + "\\" : ""; }
