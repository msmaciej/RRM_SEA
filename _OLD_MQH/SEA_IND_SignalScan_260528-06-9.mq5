...
// Panel style — local constants that mirror EA defaults.
// To change: edit directly here or expose as inputs if needed.
// Default values match Inp_UI_Panel* defaults in SEA_Config.mqh.
