...
input group "╚════════════════════════════════════════════════════════╝";
input bool        Inp_RRM_ORG_Vote_AllowPsarFlip   = false;          // RRM ORG PSAR: PSAR Enable Flip   [SYNC 2026-06-04: true→false to match SignalScan TS_PSAR_Flip=false (PSAR votes on dot position only, no flip window)]
