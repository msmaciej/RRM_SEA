...
struct ST_Settings
{
   ...
   double TrailEMA_CushionPips;        // EMA trail cushion in pips (0 = use PSAR_TrailPipsCushion as fallback)
...
input group "╚════════════════════════════════════════════════════════╝";
input int         Inp_RRM_ORG_TrailEMA_Period       = 5;             // RRM ORG TS: EMA period for TRAIL_EMA (0=use EMA1 from ribbon)
input int         Inp_RRM_ORG_TrailEMA_Shift        = 1;             // RRM ORG TS: EMA shift for TRAIL_EMA (1=tight, 2=one bar back)
input double      Inp_RRM_ORG_TrailEMA_CushionPips  = 0.0;           // RRM ORG TS: EMA trail cushion pips (0=auto from instrument scale)
