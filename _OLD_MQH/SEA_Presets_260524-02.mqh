...
void ApplyPreset(const EStrategyPreset preset, ST_Settings &cfg)
{
   ...
   if(preset == PRESET_RRM)
   {
      ...
      if(Inp_RRM_VPRR_AutoEnable)
      {
         ST_VPRRAutoMode vprr_auto = GetVPRRRecommendedMode(
            Inp_RRM_VPRR_MinRatio_Gold,      Inp_RRM_VPRR_MinRatio_Silver,
            Inp_RRM_VPRR_MinRatio_IndicesUS, Inp_RRM_VPRR_MinRatio_IndicesEU,
            Inp_RRM_VPRR_MinRatio_Oil,       Inp_RRM_VPRR_MinRatio_Crypto,
            Inp_RRM_VPRR_MinRatio_Equities,  Inp_RRM_VPRR_MinRatio_FX,
            Inp_RRM_VPRR_MinRatio_NonFXTick,
            Inp_RRM_VPRR_RecBars_Gold,       Inp_RRM_VPRR_RecBars_Silver,
            Inp_RRM_VPRR_RecBars_IndicesUS,  Inp_RRM_VPRR_RecBars_IndicesEU,
            Inp_RRM_VPRR_RecBars_Oil,        Inp_RRM_VPRR_RecBars_Crypto,
            Inp_RRM_VPRR_RecBars_Equities,   Inp_RRM_VPRR_RecBars_FX,
            Inp_RRM_VPRR_TF_Mult_M5,         Inp_RRM_VPRR_TF_Mult_M15,
            Inp_RRM_VPRR_TF_Mult_H1,         Inp_RRM_VPRR_TF_Mult_H4Plus,
            Inp_RRM_VPRR_TF_ReduceRecBars,   Inp_RRM_VPRR_RecoveryBars
         );
   ...
   if(preset == PRESET_RRM_ORG)
   {
      ...
      {
         ST_VPRRAutoMode vprr_auto = GetVPRRRecommendedMode(
            Inp_RRM_ORG_VPRR_MinRatio_Gold,      Inp_RRM_ORG_VPRR_MinRatio_Silver,
            Inp_RRM_ORG_VPRR_MinRatio_IndicesUS, Inp_RRM_ORG_VPRR_MinRatio_IndicesEU,
            Inp_RRM_ORG_VPRR_MinRatio_Oil,       Inp_RRM_ORG_VPRR_MinRatio_Crypto,
            Inp_RRM_ORG_VPRR_MinRatio_Equities,  Inp_RRM_ORG_VPRR_MinRatio_FX,
            Inp_RRM_ORG_VPRR_MinRatio_NonFXTick,
            Inp_RRM_ORG_VPRR_RecBars_Gold,       Inp_RRM_ORG_VPRR_RecBars_Silver,
            Inp_RRM_ORG_VPRR_RecBars_IndicesUS,  Inp_RRM_ORG_VPRR_RecBars_IndicesEU,
            Inp_RRM_ORG_VPRR_RecBars_Oil,        Inp_RRM_ORG_VPRR_RecBars_Crypto,
            Inp_RRM_ORG_VPRR_RecBars_Equities,   Inp_RRM_ORG_VPRR_RecBars_FX,
            Inp_RRM_ORG_VPRR_TF_Mult_M5,         Inp_RRM_ORG_VPRR_TF_Mult_M15,
            Inp_RRM_ORG_VPRR_TF_Mult_H1,         Inp_RRM_ORG_VPRR_TF_Mult_H4Plus,
            Inp_RRM_ORG_VPRR_TF_ReduceRecBars,   Inp_RRM_ORG_VPRR_RecoveryBars
         );
         cfg.VPRR_Enabled     = vprr_auto.enabled;
         cfg.VPRR_VolumeType  = vprr_auto.volume_type;
         cfg.VPRR_MinRatio    = vprr_auto.min_ratio;
   ...
   if(preset == PRESET_TOPINVESTOR)
   {
      ...
      {
         ST_VPRRAutoMode vprr_auto = GetVPRRRecommendedMode(
            Inp_TI_VPRR_MinRatio_Gold,       Inp_TI_VPRR_MinRatio_Silver,
            Inp_TI_VPRR_MinRatio_IndicesUS,  Inp_TI_VPRR_MinRatio_IndicesEU,
            Inp_TI_VPRR_MinRatio_Oil,        Inp_TI_VPRR_MinRatio_Crypto,
            Inp_TI_VPRR_MinRatio_Equities,   Inp_TI_VPRR_MinRatio_FX,
            Inp_TI_VPRR_MinRatio_NonFXTick,
            Inp_TI_VPRR_RecBars_Gold,        Inp_TI_VPRR_RecBars_Silver,
            Inp_TI_VPRR_RecBars_IndicesUS,   Inp_TI_VPRR_RecBars_IndicesEU,
            Inp_TI_VPRR_RecBars_Oil,         Inp_TI_VPRR_RecBars_Crypto,
            Inp_TI_VPRR_RecBars_Equities,    Inp_TI_VPRR_RecBars_FX,
            Inp_TI_VPRR_TF_Mult_M5,          Inp_TI_VPRR_TF_Mult_M15,
            Inp_TI_VPRR_TF_Mult_H1,          Inp_TI_VPRR_TF_Mult_H4Plus,
            Inp_TI_VPRR_TF_ReduceRecBars,    Inp_TI_VPRR_RecoveryBars
         );
         cfg.VPRR_Enabled         = vprr_auto.enabled;
         cfg.VPRR_VolumeType      = vprr_auto.volume_type;
         cfg.VPRR_MinRatio        = vprr_auto.min_ratio;
