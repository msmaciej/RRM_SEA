...
void ScanBar(int shift)
{
   ...
   // Layer pullback state must update every bar (both engines) regardless of bias,
   // so DETECTED/RECOVERED transitions accumulate correctly through pullback bars
   // where bias may be temporarily absent (e.g. EMA2 briefly below EMA3).
