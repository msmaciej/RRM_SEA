...
private:
   ...
   double GetAdaptiveThresholdPips()
   {
      ...
      //+------------------------------------------------------------------+
      //| ⚠️ IMPORTANT: Preset-Specific Behavior                          |
      //|                                                                  |
      //| DO NOT add code like: if(m_settings.Preset == PRESET_RRM)       |
      //| Reason: m_settings.Preset field does NOT exist!                 |
      //|                                                                  |
      //| Preset configuration happens in ApplyPreset() in SEA_Presets.mqh|
      //| After preset is applied, there is no runtime preset detection.  |
      //|                                                                  |
      //| If you need preset-specific behavior, do it in ApplyPreset():   |
      //|   if(preset == PRESET_RRM) {                                    |
      //|     cfg.CI_RangingThreshold = 50.0;  // RRM-specific value      |
      //|   }                                                              |
      //+------------------------------------------------------------------+
      return threshold;
   }
