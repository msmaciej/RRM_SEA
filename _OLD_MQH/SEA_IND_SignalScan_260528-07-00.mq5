...
// Panel uses same font/size/position as the EA cockpit panel (from SEA_Config.mqh):
//   Inp_UI_PanelFont, Inp_UI_PanelFontSize, Inp_UI_PanelLineSpacingPx
//   Inp_UI_CockpitX,  Inp_UI_CockpitY
...
#define SCN_PANEL_X         Inp_UI_CockpitX
#define SCN_PANEL_Y         Inp_UI_CockpitY
#define SCN_PANEL_CORNER    CORNER_LEFT_UPPER
...
void DrawInfoPanel()
{
   ...
   int x = SCN_PANEL_X;
   int y = SCN_PANEL_Y;
   int dy = (SCN_PANEL_SPACING > 0) ? SCN_PANEL_SPACING : (SCN_PANEL_FONTSIZE + 4);
