...
public:
   ...
   void GetMTFCockpitData(SMTFSegment &segments[])
   {
      ...
      int idx = 0;
      string up_arrow = ShortToString(0x25B2) + ShortToString(0x25B2);   // ▲▲ double filled triangle
      string dn_arrow = ShortToString(0x25BC) + ShortToString(0x25BC);   // ▼▼ double filled triangle
      string flat_sym = "--";
