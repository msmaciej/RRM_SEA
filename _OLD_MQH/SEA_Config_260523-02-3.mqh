...
input bool        Inp_MTF_StrictAlignment          = true;        // MTF: HTF gate — all HTFs must agree
...
input int         Inp_RRM_ORG_HtfEmaPeriod         = 89;             // MTF: DEPRECATED: Use Inp_MTF_EMA_Fast/Slow
