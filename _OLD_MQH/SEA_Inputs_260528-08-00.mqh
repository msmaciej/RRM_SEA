...
//| Included by SimpleEA_v1-04.mq5 ONLY — not by indicators.        |
//| SEA_IND_SignalScan and other indicators include SEA_Config.mqh   |
//| directly (types/structs only) without these input declarations.  |
//+------------------------------------------------------------------+
