...
input ENUM_BASE_CORNER  Inp_UI_CockpitCorner       = CORNER_RIGHT_UPPER; // UI CP: corner (right side avoids chart-comment overlap top-left)
...
input bool        Inp_UI_ShowVPRRComment           = false;          // UI: Show VPRR ACTIVE summary as chart comment (off by default)
