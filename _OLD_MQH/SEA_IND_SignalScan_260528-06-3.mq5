...
void DrawInfoPanel()
{
   ...
   string comps = "";
   if(USE_Pullback)   comps += "Pullback ";
   if(USE_DPI)        comps += "DPI ";
   if(USE_PSAR_Flip)  comps += "PSAR_Flip ";
   else if(USE_PSAR)  comps += "PSAR ";
   if(USE_MTF)        comps += "MTF ";
   if(USE_CandleBody) comps += "CandleBody ";
   if(USE_ADX)        comps += "ADX ";
   if(USE_RSI)        comps += "RSI ";
   if(USE_CCI)        comps += "CCI ";
   if(USE_MACD)       comps += "MACD ";
   if(USE_Stoch)      comps += "Stoch ";
   if(USE_BB)         comps += "BB ";
   if(USE_MFI)        comps += "MFI ";
   if(USE_ATR)        comps += "ATR ";
   if(USE_VPRR)       comps += "VPRR ";
   if(USE_CI)         comps += "CI ";
   ...
   lines[2] = "Bias: " + bias_str + "  EMA: " + (string)EMA1+"/"+EMA2+"/"+EMA3+"/"+EMA4;
   lines[3] = "ON: " + comps;
