...
input group "╚════════════════════════════════════════════════════════╝";
input bool        Inp_UI_ShowCockpitPanel          = false;          // UI CP: COCKPIT PANEL (on-chart info; off by default)
input ENUM_BASE_CORNER  Inp_UI_CockpitCorner       = CORNER_RIGHT_UPPER; // UI CP: corner (right side avoids indicator Comment() overlap in top-left)
...
input ENUM_BASE_CORNER Inp_UI_PanelCorner          = CORNER_RIGHT_UPPER; // UI SP: Status panel corner (right side avoids Comment() overlap)
