...
input double      Inp_RRM_MinDivPips         = 0.0;            // RRM MinDivPips [legacy threshold]: keep 0.0; non-zero requires EMA distance growth to exceed pip-converted threshold (legacy mode)
input group "╔════════════════════════════════════════════════════════╗";
