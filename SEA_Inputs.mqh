...
input group "=== Let Profit Run (R-ladder) - all except MA ===";
...
input group "=== Daily profit target - all except MA ===";
...
input group "=== Portfolio risk layer (account-wide; all presets; default OFF) ===";
