//+------------------------------------------------------------------+
//|              DPI_v24.mq5 - DPI_v13 + Red Contour Line            |
//| Only addition: One red line tracing histogram peaks (selected)  |
//+------------------------------------------------------------------+
#property strict
...
// Plot 9: NEW - Red histogram contour line (selected component)
...
double g_HistPos[];
double g_HistNeg[];
double g_RedContour[];  // NEW - Histogram contour line
...
int OnInit()
{
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "DPI v24 with Red Contour");
                ...
                const int &spread[])
{
   ...
   for(int i = rates_total - 2; i >= 0; --i)
   {
      ...
      g_RedContour[i] = selected;  // NEW - This traces histogram peaks
