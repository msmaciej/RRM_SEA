//+------------------------------------------------------------------+
//|              DPI_v27 - v13 + Histogram Contour Line              |
//+------------------------------------------------------------------+
#property strict
...
// Plot 9: NEW - Histogram contour/envelope line
#property indicator_label10  "Hist_Contour"
...
int OnInit()
{
   ...
   {
      Print("DPI v27: Slow EMA must be > Fast EMA.");
   ...
   SetIndexBuffer(9, g_Contour,  INDICATOR_DATA);
   ...
   ArraySetAsSeries(g_Contour,  true);
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "DPI v27");
