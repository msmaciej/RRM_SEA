                ...
                const int &spread[])
{
   ...
   for(int i = rates_total - 2; i >= 0; --i)
   {
      ...
      if(green_condition)
      {
         // GREEN: Both Blue line and histogram aligned on same side of zero
         // GREEN histogram shows from 0 to histogram value
         g_HistGreen[i] = hist;
         
         // RED/YELLOW histogram extends from 0 to Blue line (covering green + gap)
      ...
      {
         // Normal RED/YELLOW logic with CCI resets
         // No GREEN - histogram stays at normal value
