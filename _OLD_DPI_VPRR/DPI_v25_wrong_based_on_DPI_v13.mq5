//+------------------------------------------------------------------+
//|                              DPI_v24.mq5                         |
//| DPI_v13 + Red Line tracing histogram peaks                      |
//+------------------------------------------------------------------+
#property strict
...
// Plot 9: NEW - Selected component line (histogram peaks)
...
double g_HistPos[];
double g_HistNeg[];
double g_SelectedLine[];  // NEW - Shows selected component
...
int OnInit()
{
   ...
   {
      Print("DPI v24: Slow EMA must be > Fast EMA.");
   ...
   SetIndexBuffer(9, g_SelectedLine, INDICATOR_DATA);  // NEW
   ...
   ArraySetAsSeries(g_SelectedLine, true);  // NEW
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "DPI v24");
                ...
                const int &spread[])
{
   ...
   for(int i = rates_total - 2; i >= 0; --i)
   {
      ...
      g_SelectedLine[i] = selected;  // NEW - Histogram peak line
