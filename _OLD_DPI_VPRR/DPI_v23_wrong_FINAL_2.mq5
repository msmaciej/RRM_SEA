...
//| Red Line = Histogram peak heights (Selected smoothed component)  |
//+------------------------------------------------------------------+
#property strict
...
// Plot 0: Blue line = MACD Core (Fast - Slow) - MT4 DPI "Lead" line
...
// Plot 1: Red line = Histogram peaks - MT4 DPI "Follow" line
...
// Plot 3: Yellow histogram (positive)
...
// Plot 4: Green histogram (special cases)
...
//--- Buffers
double g_Blue[];
double g_RedLine[];  // Histogram peak heights = Selected smoothed component
double g_HistRed[];
double g_HistYellow[];
double g_HistGreen[];
...
int OnInit()
{
    ...
    SetIndexBuffer(1, g_RedLine, INDICATOR_DATA);
    ...
    ArraySetAsSeries(g_RedLine, true);
                ...
                const int &spread[])
{
    ...
    for(int i = rates_total - 2; i >= 0; i--)
    {
        ...
        // Red line = Histogram peak heights = Selected component
        // This traces the "follow" line in MT4 DPI
